@foreach($products as $product)
    <div class="catalogGoods__item">
        ...
        <div class="catalogGoods__thumb"><img src="/images/{{ $product->img }}" alt="" title="" id="catalogGoods__img{{ $product->id }}">
        </div>
        <p class="catalogGoods__title{{ $product->id }} --visible" id="catalogGoods__title{{ $product->id }}">{{ $product->name }}</p>
        <div class="catalogGoods__info-wrapper"><p class="catalogGoods__title">{{ $product->name }}</p>
            <!---->
        ...
        <div class="catalogGoods__actions">
            <div class="catalogGoods__price-wrapper"><p class="catalogGoods__current-price">{{ $product->price }} ₽</p></div>
            ...
            @else
                <button onclick="hello({{$product->id}})" id="addToCart{{$product->id}}" class="catalogGoods__cart"><img src="/images/assets/catalog/cart.svg" alt="" title=""> <span>В корзину</span></button>
            @endif
        </div>
    </div>
@endforeach
