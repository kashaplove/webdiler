    ...
    <div class="cartAccordionBody__item">
        <div class="cartAccordionBody__left">
            ...
            <div class="cartAccordionBody__info"><h5
                    class="cartAccordionBody__title">{{ $item->name }}</a></h5>
        ...
        <div class="cartAccordionBody__right">
            ...
            <div class="cartAccordionBody__count">
                <div class="productCalc__count productCalc__count--small product_quantity">
                    ...
                    <div class="el-input"><!---->
                        <input onchange="handleChange(this);" onclick="initQuantity({{ $item->pivot->id }})" data-ids="{{ $item->pivot->id }}" id="quantity_input{{ $item->pivot->id }}" type="text" autocomplete="off" class="el-input__inner" value="{{ $item->pivot->number_of_goods }}">
                        <!----><!----><!----><!---->
                    </div>
                </div>
            </div>
