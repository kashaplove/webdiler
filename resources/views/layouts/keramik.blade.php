    ...
    <div class="catalog__wrapper"><!---->
        <div class="catalog__actions">
            <div class="catalog__sorting">
                <div class="el-select"><!---->
                    <div class="el-input el-input--suffix"><!----><input type="text"
                                                                         readonly="readonly"
                                                                         autocomplete="off"
                                                                         placeholder="По увеличению цены"
                    ...
                    <div class="el-select-dropdown el-popper"
                         style="display: none; min-width: 189.6px;">
                        <div class="el-scrollbar" style="">
                            <div class="el-select-dropdown__wrap el-scrollbar__wrap"
                                 style="margin-bottom: -17px; margin-right: -17px;">
                                <ul class="el-scrollbar__view el-select-dropdown__list"><!---->
                                    <li class="el-select-dropdown__item selected"><span>По увеличению цены</span>
                                    </li>
                                    <li class="el-select-dropdown__item"><span>По уменьшению цены</span>
                                    </li>
                                    <li class="el-select-dropdown__item">
                                        <span>По алфавиту</span></li>
                                </ul>
                            </div>
            ...
            <div class="catalog__view-wrapper"><p class="catalog__include">
                    ...
                    <span class="img-svg el-tooltip item" aria-describedby="el-tooltip-71"
                          tabindex="0"><img src="/images/catalogInfo.svg"
                                            class="svg-icon"></span></p>
                <div class="catalog__view">
                    <button class=""><img src="/images/assets/catalog/view-grid.png" alt=""
                                          title=""></button>
                    <button class="--active"><img src="/images/assets/catalog/view-list.png"
                                                  alt="" title=""></button>
                </div>
            </div>
        </div>
        ...
        <div class="catalog__loader">
            <div tabindex="0" aria-label="Loading" class="vld-overlay is-active"
                ...
                <div class="vld-icon">
                    <svg viewBox="0 0 38 38" xmlns="http://www.w3.org/2000/svg" width="64"
                         height="64" stroke="#000">
